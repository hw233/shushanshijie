    ...
    async onFile(file: plugins.File) {
        if (file.extname == '.js') {
            ...
            if (filename == 'libs/modules/egret/egret.js' || filename == 'libs/modules/egret/egret.min.js') {
                ...
                if(filename == 'libs/modules/quicksdk/quicksdk.d.ts') {
                    content += ';window.quicksdk = quicksdk';
                }
                if(filename == 'libs/modules/talkingdata/talkingdata.d.ts') {
                    content += ';window.talkingdata = talkingdata';
                }
