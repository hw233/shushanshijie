    ...
    private _GotoView(index: ViewIndexDef, param: any) {
        switch (index) {
            ...
            case ViewIndexDef.TYPE_2001:
                ...
                break
            case ViewIndexDef.TYPE_1078: // 伙伴界面  
                ViewManager.ins().open(PetMainPanel)
                break
            case ViewIndexDef.TYPE_1079: // 红颜界面  
                ViewManager.ins().open(XianlvMainPanel)
                break
            ...
            case ViewIndexDef.TYPE_1093: //図騰转盘
                ...
                break
            case ViewIndexDef.TYPE_1094: 
                ViewManager.ins().open(ZuojiGiftWin,1)
                break
            case ViewIndexDef.TYPE_1095:
                ViewManager.ins().open(TitleGiftWin,1)
                break
...
enum ViewIndexDef {
    ...
    EquipAnneal = 10050,    // 装备淬炼 淬炼总等级达N级
    EquipAnnealAcc = 10051, //装备淬炼 装备淬炼N次
    EquipGemAll = 10060,    // 装备雕琢 装备雕琢总等级达N级
    EquipGemAcc = 10061, // 装备雕琢 升级雕琢N次

    SkillUpgrade = 20010,//武功升级到N级
    ChapterClear = 30010,//关卡通关第N关
    ChapterGoto = 30020, // 到达指定地图
    PetActive = 40010,   // 激活伙伴
    Xianlv = 40120,         // 红颜
    PetUpgrade = 40020,  // 升级伙伴N次
    ...
    TYPE_1093 = 1093, // 八脉转盘  
    TYPE_1094 = 1094, // 坐骑礼包
    TYPE_1095 = 1095, // 6元称号礼包
    TYPE_1096 = 1096, // 30元称号礼包
