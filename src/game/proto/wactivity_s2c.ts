...
namespace Sproto { 
	...
	export class sc_zj_activity_update_info_request {
		public index: number; // tag 0
		public res: number; // tag 1
	}

	function _decode_sc_zj_activity_update_info_request(d: SprotoTypeDeserialize) {
		let o = new sc_zj_activity_update_info_request;
		let t = -1;
		while (-1 != (t = d.rt())) {
			switch (t) {
			case 0:
	...
	function _encode_sc_zj_activity_update_info_request(self: sc_zj_activity_update_info_request, st: Sproto.SprotoStream) {
		let se = SprotoCore.GetSerialize(st, 2);
	...
	ALL_DICT["sc_zj_activity_update_info_request"] = {en: _encode_sc_zj_activity_update_info_request, de: _decode_sc_zj_activity_update_info_request}

	export class sc_ch_activity_update_info_request {
		public index: number; // tag 0
		public res: number; // tag 1
	}

	function _decode_sc_ch_activity_update_info_request(d: SprotoTypeDeserialize) {
		let o = new sc_ch_activity_update_info_request;
		let t = -1;
		while (-1 != (t = d.rt())) {
			switch (t) {
			case 0:
	...
	function _encode_sc_ch_activity_update_info_request(self: sc_ch_activity_update_info_request, st: Sproto.SprotoStream) {
		let se = SprotoCore.GetSerialize(st, 2);
	...
	ALL_DICT["sc_ch_activity_update_info_request"] = {en: _encode_sc_ch_activity_update_info_request, de: _decode_sc_ch_activity_update_info_request}

	export class people_health_request {
		public isadult: number;
	}

	function _decode_people_health_request(d: SprotoTypeDeserialize) {
		let o = new people_health_request;
		let t = -1;
		while (-1 != (t = d.rt())) {
			switch (t) {
			case 0:
	...
	function _encode_people_health_request(self: people_health_request, st: Sproto.SprotoStream) {
		let se = SprotoCore.GetSerialize(st, 1);

		if (self.isadult != undefined) {
			se.wi (self.isadult, 0);
		}

		return SprotoCore.CloseSerialize(se);
	}

	ALL_DICT["people_health_request"] = {en: _encode_people_health_request, de: _decode_people_health_request}
}
