...
namespace Sproto { 
	...
	export class cs_change_player_name_response {
		public sign: string; // tag 0
		public uid: string;
	...
	function _decode_cs_change_player_name_response(d: SprotoTypeDeserialize) {
		let o = new cs_change_player_name_response;
		let t = -1;
		while (-1 != (t = d.rt())) {
			switch (t) {
			case 0:
	...
	function _encode_cs_change_player_name_response(self: cs_change_player_name_response, st: Sproto.SprotoStream) {
		...
		if (self.serverId != undefined) {
			se.ws (self.serverId, 2);
		}
		if (self.serverName != undefined) {
			se.ws (self.serverName, 3);
		}
		if (self.actorid != undefined) {
			se.ws (self.actorid, 4);
		}
		if (self.roleName != undefined) {
			se.ws (self.roleName, 5);
		}
		return SprotoCore.CloseSerialize(se);
	}

	ALL_DICT["cs_change_player_name_response"] = {en: _encode_cs_change_player_name_response, de: _decode_cs_change_player_name_response}
