class ItemBase extends eui.ItemRenderer {
    ...
    public setDataByConfig(config) {
        if(typeof(this.itemIcon)=="undefined")return
    ...
    protected _UpdateRedPoint() {
        //设置红点
        if(typeof(this.redPoint)!="undefined")this.redPoint.visible = this.data.canbeUsed;
    }

    public IsShowRedPoint(isShow: boolean): void {
        if(typeof(this.redPoint)!="undefined")this.redPoint.visible = isShow
    }
    ...
    public clear() {
        ...
        if(typeof(this.itemIcon)=="undefined"){
            return
        }else if (this.itemIcon.setData != null) {
    ...
    public setCount(str) {
        ...
        if(typeof(this.count)!="undefined")this.count.text = str;
    }
...
class ItemBaseNotNameAndBg extends ItemBase{
    public constructor() {
        super()
    }
