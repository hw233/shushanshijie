...
class RoleSkilSetPanel extends BaseView implements ICommonWindowTitle {
	...
	public constructor() {
		...
		this.observe(MessageDef.SKILL_SORT_CHANGE, this.updateList)//武功顺序变化

		this.observe(MessageDef.SKILL_GREWUPALL, this.updateList)//武功变化刷新
		this.observe(MessageDef.SKILL_UPGRADE, this.updateList)//武功变化刷新
	...
	public OnOpen() {
		...
		for(let i = 0 ;i<8 ;i++)
		{
			...
			var itemIndex = skList[i] -1  //修正武功下标
