class RoleSkillPanel extends BaseView implements ICommonWindowTitle {
    ...
    UpdateContent(): void {
        ...
        this.skillDes.text = SkillsConfig.GetSkillDesc(skillId, skillLevel, selectIndex)//武功描述
        ...
        this.skillLv.textFlow =   TextFlowMaker.generateTextFlow(strSkillLv) //    skillLevel + "级"//武功等级
        ...
        if (openLevel > GameGlobal.actorModel.level) {
            ...
            this.limitLabel.text = "解锁当前武功需要到达" + openLevel + "级"
        } else {
    ...
    showHint() {
        UserTips.ErrorTip("武功等级不能超过人物等级");
    }
