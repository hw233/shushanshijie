class UserTemplate extends BaseSystem {
	...
	public static TYPE_TIANX = 3			// 精灵
	public static TYPE_SHENGB = 4			// 神兵
	public static TYPE_PET_SHOUH = 5		// 暗器
	public static TYPE_PET_TONGL = 6		// 心法
	public static TYPE_XIANLV_XW = 7		// 红颜绝技
	public static TYPE_XIANLV_FZ = 8		// 红颜阵法

	public static TYPE_HAVING_HAVING = 9	//童姥
	public static TYPE_HAVING_LINGQ = 10	//功法
	public static TYPE_HAVING_HUAN = 11	    //香囊

	public static TYPE_LINGTONG = 12 		// 随从
