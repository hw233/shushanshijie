...
class ShopController extends BaseClass {
    ...
    public getCurTipsNum(id) {
        ...
        switch (id) {
            ...
            case ShopController.EN_SHOP_ARENA:
                str = "" + (GameGlobal.ShopManage.pShopController.getShopLockByType(4) || 5000)//比武场排名
                break;
    ...
    public getShopLocakData(_index) {
        ...
        switch (_index) {
            ...
            case ShopController.EN_SHOP_ARENA: tShopData = GlobalConfig.ins().ArenaStore; break;//比武场
            case ShopController.EN_SHOP_XIANDU: tShopData = GlobalConfig.ins().XianDuStore; break;//武林大会
            ...
            case ShopController.EN_SHOP_CHONGWU: tShopData = GlobalConfig.ins().PetStoreConfig; break;//伙伴商店
            case ShopController.EN_SHOP_XIANLV: tShopData = GlobalConfig.ins().XianlvStoreConfig; break;//红颜商店
            ...
            case ShopController.EN_SHOP_PIFU: tShopData = GlobalConfig.ins().SkinStoreConfig; break;//外观商店
            ...
            case ShopController.EN_SHOP_QUJING: tShopData = GlobalConfig.ins().EscortStoreConfig; break;//护花商店
            ...
            switch (nOne) {
                ...
                case 2://大雁塔通关层级
                    ...
                    if (lv < nTwo) {
                        canBuy = false
                        if (_returnType == 1)
                            UserTips.ins().showTips("锁妖塔通关层级不足")
                ...
                case 5://西游护送次数
                    if (this.getShopLockByType(5) < nTwo) {
                        canBuy = false
                        if (_returnType == 1)
                            UserTips.ins().showTips("护送次数不足")
                        strLimit = "护送" + nTwo + "次解锁"
                    }
                    break;
                case 6://答题次数
