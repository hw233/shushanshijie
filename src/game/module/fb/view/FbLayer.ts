...
class FbLayer extends BaseEuiView implements ICommonWindow, ICommonWindowTitle {
	...
	OnOpen(...param: any[]) {
		...
		this.mCommonWindowBg.ShowTalRedPoint(1, true) //连城宝藏 红点常驻
		this.mCommonWindowBg.ShowTalRedPoint(2, true) //锁妖塔 红点常驻
	...
	OnOpenIndex(openIndex: number): boolean {
		...
		switch(openIndex)
		{
			...
			case 1:
				...
				this.uiBg2.visible = false;
				// this.commonWindowBg.SetTitle("连城宝藏");
			break;
			case 2:
				this.uiBg1.visible = false;
				this.uiBg2.visible = false;
				// this.commonWindowBg.SetTitle("锁妖塔");
			break;
			case 3:
				this.uiBg1.visible = false;
				this.uiBg2.visible = false;
				// this.commonWindowBg.SetTitle("紫禁之巅");
			break;
		}
		return true
	}
