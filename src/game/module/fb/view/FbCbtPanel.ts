...
class FbCbtPanel extends BaseView implements ICommonWindowTitle {
	...
	public static readonly NAME = "连城宝藏"
	...
	public OnOpen() {
		...
		this.observe(MessageDef.FB_CBT_UPDATE, this.updateServer)//连城宝藏变化更新
		this.observe(MessageDef.FB_CBT_UPDATE_REWARD, this.UpdateContent)//连城宝藏奖励变化更新
	...
	public setData() {
		...
		var config = GameGlobal.UserFb.getCbtPageData()//获取连城宝藏数据
	...
	public onClickItem(e: egret.TouchEvent) {
		...
		WarnWin.showReward(`|C:0x6E330B&T: 通关连城宝藏第|C:0x4fcd4c&T:${strIndex}|C:0x6E330B&T:获得|C:0x4fcd4c&T:${strLv}|C:0x6E330B&T:奖励|`,
	...
	public updateInfo() {
		var pData = this.getNowLvData()
		this.lbTitle.text = "连城宝藏" + this.nIndex//页数
