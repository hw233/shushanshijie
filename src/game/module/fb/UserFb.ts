class UserFb extends BaseSystem {
    ...
    // static readonly KIND_FB_NAME = [null, '雕琢副本', '冲穴副本', '青龙副本', '白虎副本', '门客副本', '侍女副本', '神剑副本']
    bossIndex: number = 0
    /**关卡数据 */
    /** 关卡id */
    ...
    private tFbCbtData: FbcbtData[] //连城宝藏副本列表



    private tFbCbtGetReward = [];//连城宝藏副本领取奖励条件
    ...
    private bCbtCanSwap = true;//连城宝藏副本是否可以扫荡

    public bCbtAutoFight = false;//连城宝藏副本是否可以自动战斗
    public bCbtAcross = false;//连城宝藏副本当前关卡是否已经通关

    public bTianTingAutoFight = false;//紫禁之巅副本是否可以自动战斗
