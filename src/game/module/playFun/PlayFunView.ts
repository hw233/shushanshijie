class PlayFunView extends BaseEuiView {
	...
	protected FenXiang: eui.Button; //分享
	protected ShouCang: eui.Button;	//收藏
	...
	public constructor() {
		...
		this.taskTraceBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this._OnClickMisson, this)
	}

	public _OnClickMisson() {
		GameGlobal.SoundManager.PlayEffect("MissonComplete_mp3");
	}
	...
	initUI() {
		...
		//this._AddClick(this.FenXiang, this._Onclick) //每日分享
		//this._AddClick(this.ShouCang, this._Onclick) //收藏有理
		this._AddClick(this.xuannvCard, this._Onclick)
	...
	private _Onclick(e: egret.TouchEvent) {
		switch (e.currentTarget) {
			case this.imgGoto:
				...
				break
			case this.FenXiang : //每日分享
				ViewManager.ins().open(FenXiangPanle)
				break
			case this.ShouCang : //收藏有礼
				ViewManager.ins().open(ShouCangPanel)
				break
