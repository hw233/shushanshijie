        ...
        switch (e.currentTarget) {
            ...
            case this.btnXiLian:
                if (UserBag.ins().GetCount(this.freshData[0].itemId) >= this.priceIcon2.price) {
                    ...
                    if (this.isWarn()) {
                        ...
                        WarnWin.showCheckBox("btnXiLian",'洗练属性存在|C:' + ItemBase.GetColorByQuality(quality) + '&T:[' + ItemBase.QUALITY_NAME_STR[quality] + '品质或以上]|的属性或武功，是否继续洗练？属性与武功替换后生效', this.okHandler, this);
                    } else {
            ...
            case this.btnAdvXilian:
                if (UserBag.ins().GetCount(this.freshData[1].itemId) >= this.priceIcon3.price) {
                    if (this.isWarn()) {
                         let quality = GameGlobal.HavingModel.getBaseConfig().prompt;
                        WarnWin.showCheckBox("btnAdvXilian",'洗练属性存在|C:' + ItemBase.GetColorByQuality(quality) + '&T:[' + ItemBase.QUALITY_NAME_STR[quality] + '品质以上]|的属性或武功，是否继续洗练？属性与武功替换后生效', this.okSuperHandler, this);
                    } else {
                        ...
                        if (1 == data.type) {
                            ...
                            if (config) {
                                ...
                                if (DEBUG) {
                                    ...
                                    this.curSkillDes.text = '武功ID获取不了配置：' + data.skillNo;
                                } else {
                    ...
                    if (1 == data.type) {
                        ...
                        if (config) {
                            ...
                            if (DEBUG) {
                                ...
                                this.xilianSkillDes.text = '武功ID获取不了配置：' + data.skillNo;
                            } else {
