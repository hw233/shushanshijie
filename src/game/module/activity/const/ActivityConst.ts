class ActivityConst {
	...
	public static JiJieTypeName(type:ActivityKaiFuJiJieType): string
	{
		switch (type)
		{
			...
			case ActivityKaiFuJiJieType.fairy:return "精灵"
			case ActivityKaiFuJiJieType.weapon:return "神兵"
			case ActivityKaiFuJiJieType.pet_psychic:return "伙伴暗器"
			case ActivityKaiFuJiJieType.pet_soul:return "伙伴心法"
			case ActivityKaiFuJiJieType.xianlv_circle:return "红颜绝技"
			case ActivityKaiFuJiJieType.xianlv_position:return "红颜阵法"
			case ActivityKaiFuJiJieType.tiannv:return "童姥"
			case ActivityKaiFuJiJieType.tiannv_nimbus:return "童姥功法"
			case ActivityKaiFuJiJieType.tiannv_flower:return "童姥香囊"
			case ActivityKaiFuJiJieType.lingtong:return "随从"
			case 100:return "VIP"
		}
	}
	public static JiJieTypeName2(type:ActivityKaiFuJiJieType): string
	{
		switch (type)
		{
			...
			case ActivityKaiFuJiJieType.fairy:return "精灵"
			case ActivityKaiFuJiJieType.weapon:return "神兵"
			case ActivityKaiFuJiJieType.pet_psychic:return "暗器"
			case ActivityKaiFuJiJieType.pet_soul:return "心法"
			case ActivityKaiFuJiJieType.xianlv_circle:return "绝技"
			case ActivityKaiFuJiJieType.xianlv_position:return "阵法"
			case ActivityKaiFuJiJieType.tiannv:return "童姥"
			case ActivityKaiFuJiJieType.tiannv_nimbus:return "功法"
			case ActivityKaiFuJiJieType.tiannv_flower:return "香囊"
			case ActivityKaiFuJiJieType.lingtong:return "随从"
		}
	}
...
enum ActivityKaiFuJiJieType{
	...
	pet_psychic = 5 ,//伙伴暗器
	pet_soul = 6,//伙伴心法
	xianlv_circle = 7 ,//红颜绝技
	xianlv_position = 8,//红颜阵法
	tiannv = 9 ,//童姥
	tiannv_nimbus = 10 ,//童姥功法
	tiannv_flower = 11,//童姥香囊
	lingtong = 12,//随从
}
