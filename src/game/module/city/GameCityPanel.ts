...
class GameCityPanel extends BaseEuiView {
	...
	protected titleGiftBtn: eui.Button;
	public zuojiGiftBtn: eui.Button;
	/////////////////////////////////////////////////////////////////////////////
	...
	public constructor() {
		...
		// this._AddIconRule(this.btnArenaSp, ArenaionSpIconRule)//比武商店
		...
		this._AddIconRule(this.titleGiftBtn, TitleGiftIconRule)
		this._AddIconRule(this.zuojiGiftBtn, ZuojiGiftIconRule)
