class BloodView extends egret.DisplayObjectContainer {
	...
	public static GetFont(fontName: string) {
		...
		this.m_Load = true
		RES.getResByUrl(window["RES_URL"]+"resource/assets/image/font/shanghai.json", this._CreateByUrl, this, RES.ResourceItem.TYPE_JSON)
		RES.getResByUrl(window["RES_URL"]+"resource/assets/image/font/shanghai.png", this._CreateByUrl, this, RES.ResourceItem.TYPE_IMAGE)
	}
