class MainBottomPanel extends BaseEuiView {
	...
	public OnOpen(...param: any[]) {
		...
		this.observe(MessageDef.ARENA_INFO_DATA, this.UpdateCityRedPoint)	 	 //比武场 
		this.observe(MessageDef.ARENA_BUY_RESULT, this.UpdateCityRedPoint)		 //比武场 
	...
	private UpdateCityRedPoint() {
		...
		GameGlobal.BossModel.IsRedPoint() //BOSS
			...
			|| GameGlobal.Arena.IsRedPoint() // 比武场
