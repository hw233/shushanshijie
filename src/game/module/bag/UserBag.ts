class UserBag extends BaseSystem {
	...
	public getMaxBagRoom() {
		...
		return this.bagNum + GlobalConfig.ins().VipGridConfig[UserVip.ins().lv].grid + count  ; //原本
		// return this.bagNum + GlobalConfig.ins().VipGridConfig[UserVip.ins().lv] + count  ;
		// return 10 ;

		// //更改
		// if(GlobalConfig.ins().VipGridConfig[UserVip.ins().lv] <= 20){
		// 	return this.bagNum + GlobalConfig.ins().VipGridConfig[UserVip.ins().lv].grid + count ;
		// }
		// if(GlobalConfig.ins().VipGridConfig[UserVip.ins().lv] > 20){
		// 	return this.bagNum + GlobalConfig.ins().VipGridConfig[19].grid + count ;
		// }
