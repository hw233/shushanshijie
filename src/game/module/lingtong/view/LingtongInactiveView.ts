class LingtongInactiveView extends BaseView {
	...
	private UpdateInfoLabel() {
		...
		this.info2Label.text = `需要佩戴${GameGlobal.Config.BabyBasisConfig.material.num}个${ItemBase.QUALITY_NAME_STR[GameGlobal.Config.BabyBasisConfig.material.quality]}品质的命格才能激活随从`
