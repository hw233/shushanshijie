    ...
    private _OnClick(e: egret.TouchEvent) {
        switch (e.currentTarget) {
            ...
            case this.powerLabel:
                ViewManager.ins().open(LingTongRoleTemplateAttrPanel, this.mModel, "随从", this.mModel.GetLevelSkin(this.mShowLevel))
                break
            case this.btnSkin:
            ...
            case this.btn_juexing:
                ...
                break
            case this.btnRename:
                ViewManager.ins().open(PetChangeNamePanel, "随从改名",MessageDef.LINGTONG_UPDATE_INFO, GameGlobal.LingtongAttrModel.mName, (name) => {
