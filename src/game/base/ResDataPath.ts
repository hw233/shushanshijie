...
class ResDataPath {
	...
	public static GetMapThumbnailPath(name: string) {
		return window["RES_URL"]+"resource/assets/map/" + name + "/small.jpg";
	}

	public static GetMapPreviewPath(name: string) {
		return window["RES_URL"] +"resource/assets/map/" + name + "/pk_preview.jpg";
	}
	...
	public static GetMapPath(name: string, x: number, y: number): string {
		return window["RES_URL"]+"resource/assets/map/" + name + "/image/" + y + "_" + x + ".jpg";
	}
	...
	public static GetItemFullPath(itemName: string): string {
		return window["RES_URL"] + this.ROOT_ICON + itemName + ".png"
	}
	...
	public static GetHeroEquipDefaultIcon(type: number) {
		return window["RES_URL"]+ResDataPath._HeroEquipDefaultIcon[type];
	}

	////////////////////////////////////////////// 路径 ////////////////////////////////////////////////////////////
	public static GetAssets(name: string) {
		return window["RES_URL"]+ResDataPath.ROOT + name + ".png"
	}

	public static GetMoviePath(name: string, type: string = null): string {
		if (type) {
			return window["RES_URL"]+ResDataPath.ROOT_MOVIE + type + "/" + name
		}
		return window["RES_URL"]+ResDataPath.ROOT_MOVIE + name
	}
	...
	public static GetRingPath(effeName: string): string {
		return window["RES_URL"]+ResDataPath.ROOT_MOVIE + "ring/" + effeName
	}

	public static GetMonsterBodyPath(name: string): string {
		// console.log(ResDataPath.ROOT_MOVIE + "monster/" + name)
		return window["RES_URL"]+ResDataPath.ROOT_MOVIE + "monster/" + name
	}

	// public static GetMonsterBodyPos(name: string): string{
	// 	return ResDataPath.ROOT_MOVIE + "show/" + name 
	// }

	public static GetRoleBodyPath(name: string): string {
		return window["RES_URL"]+ResDataPath.ROOT_MOVIE + "body/" + name
	}
	...
	public static GetSkillPathByID(id: string): string {
		return window["RES_URL"]+ResDataPath.ROOT_MOVIE + "skillEff/" + id
	}

	public static GetSkillPath(skillEffName: string): string {
		return window["RES_URL"]+ResDataPath.ROOT_MOVIE + "skillEff/" + skillEffName
	}

	public static GetUIEffePath(effeName: string): string {
		return window["RES_URL"]+ResDataPath.ROOT_MOVIE + "uiEffe/" + effeName
	}
	...
	public static GetRoleShowPath(name: string): string {
		...
		return window["RES_URL"]+ResDataPath.ROOT_MOVIE + "role_show/" + name
	}

	public static GetVIPImgPath(name: string): string {
		return window["RES_URL"]+ResDataPath.ROOT + "image/img/vip_show/" + name + ".png"
	}
	...
	public static GetPetImgPath(name: string): string {
		return window["RES_URL"]+ResDataPath.ROOT + "image/img/pet_show/" + name + ".png"
	}
